...
SECRET_KEY = os.environ.get("SECRET_KEY", "customer-secret-key")
...
DATABASES = {
    'default': dj_database_url.config(default=os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/customerdb"))
}
