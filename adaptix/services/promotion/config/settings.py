...
SECRET_KEY = os.environ.get("SECRET_KEY", "promotion-secret-key")
...
DATABASES = {
    'default': dj_database_url.config(default=os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/promotiondb"))
}
...
try:
    ...
    if os.environ.get("ENABLE_TRACING", "True") == "True":
        setup_tracing("promotion-service")
